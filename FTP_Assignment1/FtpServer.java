...
public class FtpServer {
	...
	public void server() throws IOException {
		...
		//		System.out.println("request : " + request);//check
	...
	private void pushFile(String contents, Socket clientSocket, PrintWriter out) throws IOException {
		...
		//	dos.writeBytes(String.valueOf(status) + System.getProperty("line.separator"));
		//	dos.writeBytes(response + System.getProperty("line.separator"));
			out.println(String.valueOf(status));
			out.println(response);
